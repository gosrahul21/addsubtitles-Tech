          ...
          <article className="prose prose-invert prose-lg md:prose-xl max-w-none font-sans text-white/80 leading-relaxed space-y-8">
            ...
            <div className="mt-20 p-10 md:p-14 rounded-[2.5rem] bg-gradient-to-br from-[#131b31] to-[#0b1329] border border-white/10 relative overflow-hidden not-prose text-center shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <Link href={AppConfig.EDITOR_URL} className="inline-flex items-center justify-center gap-3 px-10 py-5 rounded-full bg-gradient-to-b from-amber-400 to-amber-600 text-[#332b10] font-black text-xl hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_40px_rgba(212,175,55,0.3)] hover:shadow-[0_0_80px_rgba(212,175,55,0.5)]">
